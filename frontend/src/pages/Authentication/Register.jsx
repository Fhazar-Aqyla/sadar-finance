                                            ...
                                            <div className="sadar-auth-form-container">
                                                ...
                                                <div className="mt-3">
                                                    <Form
                                                        ...
                                                        {error && error ? (
                                                            <Alert color="danger" className="mb-2"><div>
                                                        ...
                                                        <div className="mb-3">
                                                            <Label htmlFor="first_name" className="form-label">Nama <span className="text-danger">*</span></Label>
                                                            <Input
                                                                id="first_name"
                                                                name="first_name"
                                                                type="text"
                                                        ...
                                                        <div className="form-check mb-3">
                                                            ...
                                                            <Label className="form-check-label text-muted fs-12 fst-italic" htmlFor="agreeTerms">
                                                                Saya menyetujui <span style={{ cursor: "pointer" }} className="text-primary text-decoration-underline fst-normal fw-medium" onClick={toggleTermsModal}>ketentuan penggunaan SADAR</span>
                                                            </Label>
                                                        </div>
                                                ...
                                                <div className="mt-4 text-center">
                                                    <p className="mb-0 fs-13">Sudah punya akun? <Link to="/login" className="fw-semibold text-primary text-decoration-underline">Masuk</Link></p>
                                                </div>
                                            </div>
                                        </Col>
                                    </Row>
