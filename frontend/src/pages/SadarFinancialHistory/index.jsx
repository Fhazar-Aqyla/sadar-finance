...
const mapCategoryToLabel = (value) => {
  ...
  return value ? value.charAt(0).toUpperCase() + value.slice(1) : "Kebutuhan";
};
...
const SadarFinancialHistory = () => {
  ...
  return (
    <div className="page-content sadar-page">
      ...
      <Modal isOpen={editModal.isOpen} toggle={closeEditModal} centered size="lg" className="sadar-history-modal">
