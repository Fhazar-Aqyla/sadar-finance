  ...
  return (
    <section ref={containerRef} className="relative py-12 lg:py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <div
        ...
        className="relative rounded-3xl border border-slate-200/90 dark:border-slate-800 bg-slate-900/95 p-2 sm:p-4 shadow-2xl shadow-slate-900/20 backdrop-blur-xl"
      >
        ...
        {/* Floating Interactive Micro-Cards (Desktop only for polish) */}
