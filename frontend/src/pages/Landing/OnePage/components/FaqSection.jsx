    ...
    >
      <div
        className={`relative rounded-2xl border transition-all duration-300 overflow-hidden cursor-pointer ${
          isOpen
            ...
            : "border-slate-200/80 dark:border-slate-800 hover:border-slate-300 dark:hover:border-slate-700 shadow-sm hover:shadow-lg"
      ...
      >
        ...
        <div className="flex items-center gap-3 px-4 py-3.5">
          <div
            className={`w-7 h-7 shrink-0 rounded-xl flex items-center justify-center transition-colors duration-300 ${
              isOpen
          ...
          <motion.div
            ...
            className={`shrink-0 w-5 h-5 rounded-lg flex items-center justify-center transition-colors duration-200 ${
              isOpen
                ? "bg-blue-50 dark:bg-blue-950/60 text-[#1E3A8A] dark:text-sky-400"
                : "text-slate-400"
            }`}
