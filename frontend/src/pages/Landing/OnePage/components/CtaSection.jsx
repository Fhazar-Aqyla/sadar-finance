  ...
  return (
    <section className="py-16 lg:py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="relative rounded-3xl overflow-hidden bg-gradient-to-tr from-blue-950 via-slate-900 to-teal-900 border border-teal-500/20 p-8 sm:p-12 lg:p-16 text-center text-white shadow-2xl">
        {/* Glow Spheres */}
        <div className="pointer-events-none absolute -top-24 -left-24 w-80 h-80 bg-teal-500/20 blur-3xl rounded-full" />
        <div className="pointer-events-none absolute -bottom-24 -right-24 w-80 h-80 bg-blue-500/20 blur-3xl rounded-full" />
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              to="/auth/register"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 rounded-2xl bg-teal-500 hover:bg-teal-400 text-slate-950 font-bold text-base shadow-xl shadow-teal-500/25 hover:scale-105 active:scale-95 transition-all"
            >
