      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-2.5 group">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-blue-900 to-teal-500 p-0.5 shadow-md shadow-teal-500/20 group-hover:scale-105 transition-transform flex items-center justify-center">
              <img
                src={sadarLogo}
                alt="SADAR Finance"
          ...
          <div className="hidden sm:flex items-center gap-3">
            ...
            <Link
              to="/auth/register"
              className="inline-flex items-center gap-1.5 px-4.5 py-2.5 rounded-xl bg-gradient-to-r from-blue-900 via-teal-700 to-teal-600 text-white text-sm font-semibold shadow-lg shadow-teal-700/20 hover:shadow-teal-700/35 hover:scale-[1.02] active:scale-[0.98] transition-all"
            >
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden mt-4 p-4 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-2xl space-y-3 animate-in fade-in slide-in-from-top-2 duration-200">
            {navLinks.map((link) => (
              <a
                key={link.label}
                href={link.href}
