    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {team.map((member, idx) => (
          <SpotlightCard
            key={idx}
            className="p-6 text-center flex flex-col items-center justify-between transition-all hover:scale-[1.02]"
          >
            <div className="flex flex-col items-center">
              {/* Avatar Photo */}
              <div className="relative w-24 h-24 rounded-2xl overflow-hidden border-2 border-teal-500/40 p-1 bg-gradient-to-tr from-teal-500 to-blue-600 shadow-lg mb-4">
                <img
                  src={member.avatar}
                  alt={member.name}
                  style={
