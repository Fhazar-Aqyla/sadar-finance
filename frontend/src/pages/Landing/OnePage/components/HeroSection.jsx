...
export const HeroSection = () => {
  ...
  return (
    ...
    >
      {/* Background Decorative Gradients - Bright & Airy */}
      <div className="pointer-events-none absolute -top-40 left-1/2 -translate-x-1/2 w-[800px] h-[500px] bg-gradient-to-tr from-cyan-400/25 via-sky-400/20 to-transparent blur-3xl rounded-full" />
      <div className="pointer-events-none absolute top-1/2 -right-40 w-96 h-96 bg-sky-300/20 blur-3xl rounded-full" />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        {/* Release Pill Badge */}
        <motion.div
          whileHover={{ scale: 1.03 }}
          className="hero-badge inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-sky-400/30 bg-sky-50/90 dark:bg-sky-950/40 text-[#1a85be] dark:text-sky-300 text-xs sm:text-sm font-semibold mb-6 backdrop-blur-sm shadow-sm cursor-default"
        >
        ...
        {/* Hero Main Headline - Vibrant Bright Blue Gradient */}
        ...
        {/* Call to Actions with Auth-consistent button styling */}
        <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 max-w-md mx-auto">
          ...
          >
            <Link
              to="/register"
              className="hero-cta w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-2xl bg-gradient-to-r from-[#0bb9a8] to-[#2c9be0] text-white font-bold text-base shadow-xl shadow-sky-500/25 hover:shadow-sky-500/40 transition-all"
            >
          ...
          >
            <a
              href="#features"
              className="hero-cta w-full sm:w-auto inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-2xl border border-slate-200 bg-white/90 text-slate-700 font-semibold text-base shadow-sm hover:border-[#25a0e2] hover:text-[#25a0e2] dark:border-slate-800 dark:bg-slate-900/80 dark:text-slate-200 dark:hover:border-sky-500 transition-all"
            >
              Jelajahi Fitur{" "}
