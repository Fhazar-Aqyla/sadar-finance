...
const Register = () => {
    ...
    return (
        <React.Fragment>
                                    ...
                                    <Row className="g-0">
                                        ...
                                        <div className="p-2 mt-4 sadar-auth-form-body">
                                            <Form
                                                ...
                                                <div className="mb-2">
                                                    <Label htmlFor="confirmPassword" className="form-label">Konfirmasi Password <span className="text-danger">*</span></Label>
                                                    <div className="position-relative auth-pass-inputgroup">
                                                        <Input
                                                            id="confirmPassword"
                                                ...
                                                <div className="form-check mb-4 sadar-auth-terms-check">
                                                    <Input
                                                        ...
                                                        aria-describedby={termsError ? "agreeTermsError" : undefined}
                                                        onChange={(e) => {
                                                    ...
                                                    <div className="sadar-auth-terms-copy">
                                                        <Label className="form-check-label text-muted" htmlFor="agreeTerms">Saya menyetujui</Label>{" "}
                                                        <button type="button" className="sadar-auth-terms-link" aria-label="Baca ketentuan penggunaan SADAR Finance" onClick={toggleTermsModal}>ketentuan SADAR Finance</button>
                                                    </div>
                                                </div>
                                                {termsError && (
                                                    <div id="agreeTermsError" className="sadar-auth-terms-error" role="alert">
            ...
            <Modal isOpen={showTermsModal} toggle={toggleTermsModal} centered size="lg" className="sadar-history-modal sadar-auth-terms-modal" backdropClassName="sadar-auth-terms-backdrop">
