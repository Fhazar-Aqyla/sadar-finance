...
const categoryLabels = ["Kebutuhan", "Keinginan", "Tabungan"];
const categoryColors = ["#2563EB", "#8B5CF6", "#10B981"];
...
const getTransactionCategory = (transaction) => {
  ...
  if (transaction.category) {
    return mapCategoryToLabel(transaction.category);
  }
        ...
        <section className="sadar-overview">
          ...
          <div className="sadar-overview-note">
            ...
            <div className="sadar-alert-copy">
              ...
              <strong className="sadar-alert-title">{dashboardAlert.title}</strong>
              <p>{dashboardAlert.message}</p>
