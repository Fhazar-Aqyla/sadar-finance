...
export const Cta4 = ({
  ...
  return (
    <section className="relative overflow-hidden rounded-[28px] border border-[#2B4B9B] bg-[#1E3A8A] px-8 py-12 text-white shadow-[0_20px_50px_rgba(30,58,138,0.22)] md:px-16 md:py-16">
      ...
      <div
        className="pointer-events-none absolute -right-24 -top-24 h-96 w-96 rounded-full bg-[#14B8A6] opacity-20 blur-[80px]"
        aria-hidden="true"
      />
      <div
      ...
      <div className="relative z-10 flex flex-col items-center justify-between gap-10 md:flex-row lg:gap-20">
